...
const initialUsers = [
  ...
  { id: 4, name: "William", email: "William@example.com", role: "Contributer", status: 'active' },
];
            ...
            <tr key={user.id}>
              ...
              <td className="py-2 px-4 border-b">
                <button 
                  ...
                  className={`px-2 py-1 rounded ${user.status === 'active' ? 'bg-green-500 text-white' : 'bg-yellow-500 text-white'}`}
                >
                  {user.status}
                </button>
              </td>
